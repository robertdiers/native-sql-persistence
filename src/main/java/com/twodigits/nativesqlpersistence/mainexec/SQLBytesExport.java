	...
	public static void main(String[] args) {
		...
		try{
			...
			{				
				...
				System.out.println("java -cp native-sql-persistence.jar:<database-driver.jar> com.twodigits.nativesqlpersistence.mainexec.SQLBytesExport <url> <DriverClass> <User> <Password> \"<SQL>\"");
